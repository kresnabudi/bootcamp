<html lang="en-US" style="overflow: hidden;"><head>
...
<ul class="main-menu sm sm-clean" data-smartmenus-id="15653230944932913">
<li>
<a href="index.html" class="current">Home</a>
</li>
<li>
<a href="about.html" class="has-submenu" id="sm-15653230944932913-1" aria-haspopup="true" aria-controls="sm-15653230944932913-2" aria-expanded="false"><span class="sub-arrow">+</span>About</a>
<ul class="sub-menu" id="sm-15653230944932913-2" role="group" aria-hidden="true" aria-labelledby="sm-15653230944932913-1" aria-expanded="false">
<li>
...
<canvas class="particles-js-canvas-el" width="1280" height="659" style="width: 100%; height: 100%;"></canvas></div>
...
<a href="https://vimeo.com/157276599" data-rel="prettyPhoto[1]" rel="prettyPhoto[1]">
...
<div class="caroufredsel_wrapper" style="display: block; text-align: center; float: none; position: relative; top: auto; right: auto; bottom: auto; left: auto; width: 1170px; height: 290px; margin: 0px; overflow: hidden; cursor: move;"><ul id="demo1" class="slides testimonial" style="text-align: left; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: 0px; margin: 0px; width: 8190px; height: 290px;">
...
<div id="demo1_pagination" class="carousel_pagination left" style="display: block; margin-left: 532.5px;"><a href="#" class="selected"><span>1</span></a><a href="#" class=""><span>2</span></a><a href="#" class=""><span>3</span></a></div>
<div class="clear"></div>
</div>
</div>
<div class="clear"></div>
...
<div id="ascrail2000" class="nicescroll-rails nicescroll-rails-vr" style="width: 12px; z-index: auto; cursor: default; position: fixed; top: 0px; height: 100%; right: 0px; touch-action: none; opacity: 0; display: block;"><div class="nicescroll-cursors" style="position: relative; top: 14px; float: right; width: 12px; height: 89px; background-color: rgb(205, 200, 193); border: none; background-clip: padding-box; border-radius: 0px; touch-action: none;"></div></div><div id="ascrail2000-hr" class="nicescroll-rails nicescroll-rails-hr" style="height: 12px; z-index: auto; position: fixed; left: 0px; width: 100%; bottom: 0px; cursor: default; display: none; opacity: 0;"><div class="nicescroll-cursors" style="position: absolute; top: 0px; height: 12px; width: 1280px; background-color: rgb(205, 200, 193); border: none; background-clip: padding-box; border-radius: 0px;"></div></div><div style="display: none;"></div></body></html>
  @yield('content')
</body>
</html>